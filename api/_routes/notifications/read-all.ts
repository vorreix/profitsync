...
// Mark unread notifications as read for the ACTIVE org plus account-level
// (org-less) ones — matching the org-scoped drawer (see
// api/_routes/notifications.ts). Optional body { category } limits it to one.
