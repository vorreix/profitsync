  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">All organizations across the platform.</p>
      </div>
                ...
                data.map((o) => (
                  <tr key={o.id} className="border-t border-border hover:bg-muted/40">
                    ...
                    <td className="py-3 text-right">
                      <Button size="icon" variant="ghost" aria-label="Rename" onClick={() => { setEditTarget(o); setEditName(o.name) }}>
